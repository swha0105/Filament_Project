...
for cluster_num in np.sort(os.listdir(ref_path + 'label/segment/')):
    
    cluster_path = ref_path + 'label/segment/' + str(cluster_num) + '/'
    fitting_path = ref_path + 'filament/fitting/' + str(cluster_num) + '/'
    curvature_path = ref_path + 'filament/curvature/' + str(cluster_num) + '/'
